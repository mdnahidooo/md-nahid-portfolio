...
export default function Contact() {
    ...
    // EMAIL SEND FUNCTION VIA NEXT.JS API ROUTE
    const sendEmail = async (e) => {
        e.preventDefault();
        setLoading(true);
        setSuccess(false);
        ...
        try {
            ...
            if (response.ok && result.success) {
                ...
                setErrorMsg(result.error || "Failed to send message. Try again later.");
            }
        } catch (err) {
            console.error(err);
        ...
        >
            ...
            <div className="mt-14 grid md:grid-cols-2 gap-10">
                ...
                <form ref={formRef} onSubmit={sendEmail} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full py-5 rounded-lg" disabled={loading}>
                        {loading ? "Sending..." : "Send Message"}
                    </Button>
